...
import "../CRC4/ICRC4Enumerable.sol";

/**
 * @title ERC-721 Non-Fungible Token with optional enumeration extension logic
 * @dev See https://eips.ethereum.org/EIPS/eip-721
 */
contract CRC4EnumerableUpgradeable is Initializable, CRC3Upgradeable, CRC4Upgradeable, ICRC4Enumerable {
    ...
    function initialize () public initializer {
        require(CRC4Upgradeable._hasBeenInitialized());
